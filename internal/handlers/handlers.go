// Package handlers provides HTTP handler functions for the API.
package handlers
...
// Home writes a personal introduction message.
// It is used on the root path.
...
// Qoute writes an inspirational quote.
// Note: kept the original spelling of the route '/qoute'.
